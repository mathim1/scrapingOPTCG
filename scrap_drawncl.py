...
def obtener_info_producto(url):
    # Verificar que la URL comience con "https://drawn.cl/"
    ...
    # Obtener el título del producto del elemento H1 con la clase 'product-title product_title entry-title'
    ...
    # Encontrar el precio final en el span con la clase 'woocommerce-Price-amount amount'
    final_price_element = soup.find('span', {'class': 'woocommerce-Price-amount amount'})
